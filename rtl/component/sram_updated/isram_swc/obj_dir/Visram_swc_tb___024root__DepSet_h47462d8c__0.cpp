...
VL_INLINE_OPT VlCoroutine Visram_swc_tb___024root___eval_initial__TOP__0(Visram_swc_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Visram_swc_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Visram_swc_tb___024root___eval_initial__TOP__0\n"); );
    // Init
    ...
    co_await vlSelf->__VdlySched.delay(0x3a98ULL, nullptr, 
                                       "isram_swc_tb.v", 
                                       38);
    VL_FINISH_MT("isram_swc_tb.v", 38, "");
}
