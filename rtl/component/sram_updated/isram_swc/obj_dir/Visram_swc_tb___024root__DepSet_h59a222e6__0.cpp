...
VlCoroutine Visram_swc_tb___024root___eval_initial__TOP__0(Visram_swc_tb___024root* vlSelf);
VlCoroutine Visram_swc_tb___024root___eval_initial__TOP__1(Visram_swc_tb___024root* vlSelf);
VlCoroutine Visram_swc_tb___024root___eval_initial__TOP__2(Visram_swc_tb___024root* vlSelf);
...
void Visram_swc_tb___024root___eval_initial(Visram_swc_tb___024root* vlSelf) {
    ...
    Visram_swc_tb___024root___eval_initial__TOP__0(vlSelf);
    Visram_swc_tb___024root___eval_initial__TOP__1(vlSelf);
    Visram_swc_tb___024root___eval_initial__TOP__2(vlSelf);
...
VL_INLINE_OPT VlCoroutine Visram_swc_tb___024root___eval_initial__TOP__1(Visram_swc_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Visram_swc_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Visram_swc_tb___024root___eval_initial__TOP__1\n"); );
    // Body
    ...
    co_await vlSelf->__VdlySched.delay(0xaULL, nullptr, 
                                       ...
                                       64);
    vlSelf->__Vm_traceActivity[2U] = 1U;
    VL_FINISH_MT("isram_swc_tb.v", 67, "");
    vlSelf->__Vm_traceActivity[2U] = 1U;
}

VL_INLINE_OPT VlCoroutine Visram_swc_tb___024root___eval_initial__TOP__2(Visram_swc_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Visram_swc_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Visram_swc_tb___024root___eval_initial__TOP__2\n"); );
    // Body
    while (1U) {
