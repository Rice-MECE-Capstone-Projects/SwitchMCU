...
VL_INLINE_OPT VlCoroutine Vdsram_swc_tb___024root___eval_initial__TOP__0(Vdsram_swc_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vdsram_swc_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdsram_swc_tb___024root___eval_initial__TOP__0\n"); );
    // Init
    ...
    co_await vlSelf->__VdlySched.delay(0x3a98ULL, nullptr, 
                                       "dsram_swc_tb.v", 
                                       39);
    VL_FINISH_MT("dsram_swc_tb.v", 39, "");
}
