...
VlCoroutine Vdsram_swc_tb___024root___eval_initial__TOP__0(Vdsram_swc_tb___024root* vlSelf);
VlCoroutine Vdsram_swc_tb___024root___eval_initial__TOP__1(Vdsram_swc_tb___024root* vlSelf);
VlCoroutine Vdsram_swc_tb___024root___eval_initial__TOP__2(Vdsram_swc_tb___024root* vlSelf);
...
void Vdsram_swc_tb___024root___eval_initial(Vdsram_swc_tb___024root* vlSelf) {
    ...
    Vdsram_swc_tb___024root___eval_initial__TOP__0(vlSelf);
    Vdsram_swc_tb___024root___eval_initial__TOP__1(vlSelf);
    Vdsram_swc_tb___024root___eval_initial__TOP__2(vlSelf);
...
VL_INLINE_OPT VlCoroutine Vdsram_swc_tb___024root___eval_initial__TOP__1(Vdsram_swc_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vdsram_swc_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdsram_swc_tb___024root___eval_initial__TOP__1\n"); );
    // Body
    ...
    co_await vlSelf->__VdlySched.delay(0xaULL, nullptr, 
                                       ...
                                       79);
    vlSelf->__Vm_traceActivity[2U] = 1U;
    VL_FINISH_MT("dsram_swc_tb.v", 82, "");
    vlSelf->__Vm_traceActivity[2U] = 1U;
}

VL_INLINE_OPT VlCoroutine Vdsram_swc_tb___024root___eval_initial__TOP__2(Vdsram_swc_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vdsram_swc_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdsram_swc_tb___024root___eval_initial__TOP__2\n"); );
    // Body
    while (1U) {
...
VL_INLINE_OPT void Vdsram_swc_tb___024root___nba_sequent__TOP__0(Vdsram_swc_tb___024root* vlSelf) {
    ...
    // Init
    SData/*9:0*/ __Vdlyvdim0__dsram_swc_tb__DOT__dsram_inst__DOT__data_sram__v0;
    __Vdlyvdim0__dsram_swc_tb__DOT__dsram_inst__DOT__data_sram__v0 = 0;
    IData/*31:0*/ __Vdlyvval__dsram_swc_tb__DOT__dsram_inst__DOT__data_sram__v0;
    __Vdlyvval__dsram_swc_tb__DOT__dsram_inst__DOT__data_sram__v0 = 0;
    CData/*0:0*/ __Vdlyvset__dsram_swc_tb__DOT__dsram_inst__DOT__data_sram__v0;
    __Vdlyvset__dsram_swc_tb__DOT__dsram_inst__DOT__data_sram__v0 = 0;
    // Body
    __Vdlyvset__dsram_swc_tb__DOT__dsram_inst__DOT__data_sram__v0 = 0U;
    if ((1U & (~ ((~ (IData)(vlSelf->dsram_swc_tb__DOT__hrstn)) 
        ...
        if ((1U != (IData)(vlSelf->dsram_swc_tb__DOT__dsram_inst__DOT__next_state))) {
            if ((2U == (IData)(vlSelf->dsram_swc_tb__DOT__dsram_inst__DOT__next_state))) {
                __Vdlyvval__dsram_swc_tb__DOT__dsram_inst__DOT__data_sram__v0 
                    = vlSelf->dsram_swc_tb__DOT__hwdata;
                __Vdlyvset__dsram_swc_tb__DOT__dsram_inst__DOT__data_sram__v0 = 1U;
                __Vdlyvdim0__dsram_swc_tb__DOT__dsram_inst__DOT__data_sram__v0 
    ...
    if (__Vdlyvset__dsram_swc_tb__DOT__dsram_inst__DOT__data_sram__v0) {
        vlSelf->dsram_swc_tb__DOT__dsram_inst__DOT__data_sram[__Vdlyvdim0__dsram_swc_tb__DOT__dsram_inst__DOT__data_sram__v0] 
            = __Vdlyvval__dsram_swc_tb__DOT__dsram_inst__DOT__data_sram__v0;
    }
}
