...
VL_ATTR_COLD void Vapb_swc_tb___024root__trace_init_sub__TOP__0(Vapb_swc_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+24,"PD_NUM", false,-1, 31,0);
    tracep->declBit(c+22,"pclk", false,-1);
    ...
    tracep->declBit(c+25,"pslverr", false,-1);
    ...
    tracep->declBit(c+1,"prstn", false,-1);
    tracep->declBus(c+7,"paddr", false,-1, 31,0);
    tracep->declBit(c+18,"psel", false,-1);
    tracep->declBit(c+9,"penable", false,-1);
    tracep->declBit(c+10,"pwrite", false,-1);
    tracep->declBus(c+11,"pwdata", false,-1, 31,0);
    tracep->declBit(c+12,"pready", false,-1);
...
VL_ATTR_COLD void Vapb_swc_tb___024root__trace_full_sub_0(Vapb_swc_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+17,(vlSelf->apb_swc_tb__DOT__apbm_swc_inst__DOT__state),2);
    bufp->fullBit(oldp+18,((1U & (IData)(vlSelf->apb_swc_tb__DOT__pselx))));
    bufp->fullIData(oldp+19,(vlSelf->apb_swc_tb__DOT__apbs_swc_inst__DOT__SPI_CR),32);
    bufp->fullIData(oldp+20,(vlSelf->apb_swc_tb__DOT__apbs_swc_inst__DOT__SPI_SR),32);
    bufp->fullIData(oldp+21,(vlSelf->apb_swc_tb__DOT__apbs_swc_inst__DOT__SPI_WDR),32);
    bufp->fullBit(oldp+22,(vlSelf->apb_swc_tb__DOT__pclk));
    bufp->fullCData(oldp+23,(vlSelf->apb_swc_tb__DOT__apbm_swc_inst__DOT__nextstate),2);
