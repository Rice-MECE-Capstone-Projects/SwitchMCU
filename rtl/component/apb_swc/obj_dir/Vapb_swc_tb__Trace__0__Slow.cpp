...
VL_ATTR_COLD void Vapb_swc_tb___024root__trace_init_sub__TOP__0(Vapb_swc_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+22,"PD_NUM", false,-1, 31,0);
    tracep->declBit(c+20,"pclk", false,-1);
    ...
    tracep->declBit(c+23,"pslverr", false,-1);
    ...
    tracep->declBit(c+24,"rbuffwrite", false,-1);
    tracep->declBit(c+5,"rreq", false,-1);
    tracep->declBus(c+25,"rbuffdata", false,-1, 31,0);
    tracep->declBus(c+6,"rbuffaddr", false,-1, 31,0);
    tracep->declBus(c+26,"cnt", false,-1, 7,0);
    ...
    tracep->declBus(c+25,"rbuffdata", false,-1, 31,0);
    tracep->declBus(c+6,"rbuffaddr", false,-1, 31,0);
    tracep->declBus(c+27,"IDLE", false,-1, 31,0);
    tracep->declBus(c+28,"STEUP", false,-1, 31,0);
    tracep->declBus(c+29,"ACCESS", false,-1, 31,0);
    tracep->declBus(c+15,"state", false,-1, 1,0);
    tracep->declBus(c+21,"nextstate", false,-1, 1,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("apbs_swc_inst ");
    tracep->declBus(c+30,"SPI_CR_ADDR", false,-1, 31,0);
    tracep->declBus(c+31,"SPI_SR_ADDR", false,-1, 31,0);
    tracep->declBus(c+32,"SPI_WDR_ADDR", false,-1, 31,0);
    tracep->declBus(c+33,"SPI_RDR_ADDR", false,-1, 31,0);
    tracep->declBus(c+22,"PD_NUM", false,-1, 31,0);
    tracep->declBit(c+20,"pclk", false,-1);
    tracep->declBit(c+1,"prstn", false,-1);
    tracep->declBus(c+7,"paddr", false,-1, 31,0);
    ...
    tracep->declBus(c+18,"SPI_SR", false,-1, 31,0);
    tracep->declBus(c+19,"SPI_WDR", false,-1, 31,0);
    tracep->declBus(c+34,"SPI_RDR", false,-1, 31,0);
...
VL_ATTR_COLD void Vapb_swc_tb___024root__trace_full_sub_0(Vapb_swc_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+18,(vlSelf->apb_swc_tb__DOT__apbs_swc_inst__DOT__SPI_SR),32);
    bufp->fullIData(oldp+19,(vlSelf->apb_swc_tb__DOT__apbs_swc_inst__DOT__SPI_WDR),32);
    bufp->fullBit(oldp+20,(vlSelf->apb_swc_tb__DOT__pclk));
    bufp->fullCData(oldp+21,(vlSelf->apb_swc_tb__DOT__apbm_swc_inst__DOT__nextstate),2);
    bufp->fullIData(oldp+22,(3U),32);
    bufp->fullBit(oldp+23,(0U));
    bufp->fullBit(oldp+24,(vlSelf->apb_swc_tb__DOT__rbuffwrite));
    bufp->fullIData(oldp+25,(vlSelf->apb_swc_tb__DOT__rbuffdata),32);
    bufp->fullCData(oldp+26,(vlSelf->apb_swc_tb__DOT__cnt),8);
    bufp->fullIData(oldp+27,(0U),32);
    bufp->fullIData(oldp+28,(1U),32);
    bufp->fullIData(oldp+29,(2U),32);
    bufp->fullIData(oldp+30,(0x100000U),32);
    bufp->fullIData(oldp+31,(0x100004U),32);
    bufp->fullIData(oldp+32,(0x100008U),32);
    bufp->fullIData(oldp+33,(0x10000cU),32);
    bufp->fullIData(oldp+34,(vlSelf->apb_swc_tb__DOT__apbs_swc_inst__DOT__SPI_RDR),32);
}
