...
VL_INLINE_OPT VlCoroutine Vahbm_swc_tb___024root___eval_initial__TOP__0(Vahbm_swc_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbm_swc_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbm_swc_tb___024root___eval_initial__TOP__0\n"); );
    // Init
    VlWide<4>/*127:0*/ __Vtemp_h156acb5c__0;
    // Body
    __Vtemp_h156acb5c__0[0U] = 0x2e766364U;
    __Vtemp_h156acb5c__0[1U] = 0x635f7462U;
    __Vtemp_h156acb5c__0[2U] = 0x6d5f7377U;
    __Vtemp_h156acb5c__0[3U] = 0x616862U;
    vlSymsp->_vm_contextp__->dumpfile(VL_CVT_PACK_STR_NW(4, __Vtemp_h156acb5c__0));
