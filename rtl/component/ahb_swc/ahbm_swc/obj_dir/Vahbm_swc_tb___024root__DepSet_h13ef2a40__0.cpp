...
VlCoroutine Vahbm_swc_tb___024root___eval_initial__TOP__0(Vahbm_swc_tb___024root* vlSelf);
VlCoroutine Vahbm_swc_tb___024root___eval_initial__TOP__1(Vahbm_swc_tb___024root* vlSelf);
VlCoroutine Vahbm_swc_tb___024root___eval_initial__TOP__2(Vahbm_swc_tb___024root* vlSelf);
...
void Vahbm_swc_tb___024root___eval_initial(Vahbm_swc_tb___024root* vlSelf) {
    ...
    Vahbm_swc_tb___024root___eval_initial__TOP__0(vlSelf);
    Vahbm_swc_tb___024root___eval_initial__TOP__1(vlSelf);
    Vahbm_swc_tb___024root___eval_initial__TOP__2(vlSelf);
    vlSelf->__Vtrigprevexpr___TOP__ahbm_swc_tb__DOT__hclk__0 
        = vlSelf->ahbm_swc_tb__DOT__hclk;
}

VL_INLINE_OPT VlCoroutine Vahbm_swc_tb___024root___eval_initial__TOP__1(Vahbm_swc_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbm_swc_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbm_swc_tb___024root___eval_initial__TOP__1\n"); );
    // Body
...
VL_INLINE_OPT VlCoroutine Vahbm_swc_tb___024root___eval_initial__TOP__2(Vahbm_swc_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbm_swc_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbm_swc_tb___024root___eval_initial__TOP__2\n"); );
    // Body
    while (1U) {
...
VL_INLINE_OPT void Vahbm_swc_tb___024root___act_sequent__TOP__0(Vahbm_swc_tb___024root* vlSelf) {
    ...
    vlSelf->ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__nextstate 
        = Vahbm_swc_tb__ConstPool__TABLE_hae662c23_0
        [__Vtableidx1];
}
...
VL_INLINE_OPT void Vahbm_swc_tb___024root___nba_sequent__TOP__0(Vahbm_swc_tb___024root* vlSelf) {
    ...
    CData/*0:0*/ __Vdly__ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__wpendingflag;
    __Vdly__ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__wpendingflag = 0;
    ...
    __Vdly__ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__wpendingflag 
    ...
    if (vlSelf->ahbm_swc_tb__DOT__hrstn) {
        if (vlSelf->ahbm_swc_tb__DOT__hready) {
            vlSelf->ahbm_swc_tb__DOT__hwdata = vlSelf->ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__hwdatabuff;
            __Vdly__ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__wpendingflagdly 
                = vlSelf->ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__wpendingflag;
            __Vdly__ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__rpendingflagdly 
                = vlSelf->ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__rpendingflag;
        } else {
            vlSelf->ahbm_swc_tb__DOT__hwdata = vlSelf->ahbm_swc_tb__DOT__hwdata;
            __Vdly__ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__wpendingflagdly 
                = vlSelf->ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__wpendingflagdly;
            __Vdly__ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__rpendingflagdly 
                = vlSelf->ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__rpendingflagdly;
        ...
        if ((0U == (IData)(vlSelf->ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__nextstate))) {
            ...
            __Vdly__ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__wpendingflag = 0U;
            ...
            if (vlSelf->ahbm_swc_tb__DOT__wreq) {
                ...
                __Vdly__ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__wpendingflag = 1U;
            } else {
                vlSelf->ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__hwdatabuff = 0U;
            ...
            __Vdly__ahbm_swc_tb__DOT__haddr = 0U;
            __Vdly__ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__wpendingflag = 0U;
            vlSelf->ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__rpendingflag = 0U;
        }
        ...
        vlSelf->ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__state 
            = vlSelf->ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__nextstate;
        vlSelf->ahbm_swc_tb__DOT__hwrite = ((0U != (IData)(vlSelf->ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__nextstate)) 
                                            & ((1U 
        ...
        vlSelf->ahbm_swc_tb__DOT__done = ((IData)(vlSelf->ahbm_swc_tb__DOT__hready) 
                                          & ((IData)(vlSelf->ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__rpendingflagdly) 
                                             | (IData)(vlSelf->ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__wpendingflagdly)));
        vlSelf->ahbm_swc_tb__DOT__resp = (((IData)(vlSelf->ahbm_swc_tb__DOT__hready) 
                                           & (IData)(vlSelf->ahbm_swc_tb__DOT__hresp)) 
                                          & ((IData)(vlSelf->ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__rpendingflagdly) 
                                             | (IData)(vlSelf->ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__wpendingflagdly)));
    } else {
        ...
        __Vdly__ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__wpendingflagdly = 0U;
        __Vdly__ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__rpendingflagdly = 0U;
        vlSelf->ahbm_swc_tb__DOT__hwrite = 0U;
        vlSelf->ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__rpendingflag = 0U;
        vlSelf->ahbm_swc_tb__DOT__done = 0U;
        vlSelf->ahbm_swc_tb__DOT__resp = 0U;
    }
    vlSelf->ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__wpendingflag 
        = __Vdly__ahbm_swc_tb__DOT__ahbm_swc_inst__DOT__wpendingflag;
