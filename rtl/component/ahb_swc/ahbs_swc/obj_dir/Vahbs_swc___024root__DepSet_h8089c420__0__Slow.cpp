...
VL_ATTR_COLD void Vahbs_swc___024root___eval_static__TOP(Vahbs_swc___024root* vlSelf);

VL_ATTR_COLD void Vahbs_swc___024root___eval_static(Vahbs_swc___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbs_swc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbs_swc___024root___eval_static\n"); );
    // Body
    Vahbs_swc___024root___eval_static__TOP(vlSelf);
}

VL_ATTR_COLD void Vahbs_swc___024root___eval_static__TOP(Vahbs_swc___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbs_swc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbs_swc___024root___eval_static__TOP\n"); );
    // Body
    vlSelf->ahbs_swc_tb__DOT__hclk = 1U;
}

VL_ATTR_COLD void Vahbs_swc___024root___eval_final(Vahbs_swc___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbs_swc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbs_swc___024root___eval_final\n"); );
}
...
#endif  // VL_DEBUG
VL_ATTR_COLD void Vahbs_swc___024root___eval_stl(Vahbs_swc___024root* vlSelf);

VL_ATTR_COLD void Vahbs_swc___024root___eval_settle(Vahbs_swc___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbs_swc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbs_swc___024root___eval_settle\n"); );
    // Init
    ...
    while (__VstlContinue) {
        __VstlContinue = 0U;
        Vahbs_swc___024root___eval_triggers__stl(vlSelf);
        if (vlSelf->__VstlTriggered.any()) {
            ...
            Vahbs_swc___024root___eval_stl(vlSelf);
        }
    }
}
...
VL_ATTR_COLD void Vahbs_swc___024root___dump_triggers__stl(Vahbs_swc___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbs_swc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbs_swc___024root___dump_triggers__stl\n"); );
    // Body
...
void Vahbs_swc___024root___act_sequent__TOP__0(Vahbs_swc___024root* vlSelf);

VL_ATTR_COLD void Vahbs_swc___024root___eval_stl(Vahbs_swc___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbs_swc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbs_swc___024root___eval_stl\n"); );
    // Body
    if ((1ULL & vlSelf->__VstlTriggered.word(0U))) {
...
VL_ATTR_COLD void Vahbs_swc___024root___dump_triggers__act(Vahbs_swc___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbs_swc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbs_swc___024root___dump_triggers__act\n"); );
    // Body
...
VL_ATTR_COLD void Vahbs_swc___024root___dump_triggers__nba(Vahbs_swc___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbs_swc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbs_swc___024root___dump_triggers__nba\n"); );
    // Body
...
VL_ATTR_COLD void Vahbs_swc___024root___ctor_var_reset(Vahbs_swc___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbs_swc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbs_swc___024root___ctor_var_reset\n"); );
    // Body
