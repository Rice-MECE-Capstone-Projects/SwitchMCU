...
VL_INLINE_OPT VlCoroutine Vahbs_swc___024root___eval_initial__TOP__0(Vahbs_swc___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbs_swc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbs_swc___024root___eval_initial__TOP__0\n"); );
    // Init
...
void Vahbs_swc___024root___eval_triggers__act(Vahbs_swc___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbs_swc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbs_swc___024root___eval_triggers__act\n"); );
    // Body
