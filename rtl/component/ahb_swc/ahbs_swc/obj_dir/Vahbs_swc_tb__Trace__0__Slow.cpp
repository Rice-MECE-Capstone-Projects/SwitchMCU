...
VL_ATTR_COLD void Vahbs_swc_tb___024root__trace_init_sub__TOP__0(Vahbs_swc_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+14,"hclk", false,-1);
    ...
    tracep->declBus(c+17,"hwdata", false,-1, 31,0);
    tracep->declBus(c+8,"hrdata", false,-1, 31,0);
    tracep->declBit(c+7,"hwrite", false,-1);
    tracep->declBit(c+18,"hready", false,-1);
    tracep->declBit(c+19,"hresp", false,-1);
    tracep->declBit(c+9,"wreq", false,-1);
    tracep->declBus(c+10,"wbuffdata", false,-1, 31,0);
    tracep->declBus(c+11,"wbuffaddr", false,-1, 31,0);
    tracep->declBit(c+12,"rreq", false,-1);
    tracep->declBus(c+20,"rbuffdata", false,-1, 31,0);
    tracep->declBus(c+13,"rbuffaddr", false,-1, 31,0);
    ...
    tracep->declBus(c+16,"next_state", false,-1, 3,0);
...
VL_ATTR_COLD void Vahbs_swc_tb___024root__trace_full_sub_0(Vahbs_swc_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+7,(vlSelf->ahbs_swc_tb__DOT__hwrite));
    bufp->fullIData(oldp+8,(vlSelf->ahbs_swc_tb__DOT__hrdata),32);
    bufp->fullBit(oldp+9,(vlSelf->ahbs_swc_tb__DOT__wreq));
    bufp->fullIData(oldp+10,(vlSelf->ahbs_swc_tb__DOT__wbuffdata),32);
    bufp->fullIData(oldp+11,(vlSelf->ahbs_swc_tb__DOT__wbuffaddr),32);
    bufp->fullBit(oldp+12,(vlSelf->ahbs_swc_tb__DOT__rreq));
    bufp->fullIData(oldp+13,(vlSelf->ahbs_swc_tb__DOT__rbuffaddr),32);
    bufp->fullBit(oldp+14,(vlSelf->ahbs_swc_tb__DOT__hclk));
    bufp->fullCData(oldp+15,(vlSelf->ahbs_swc_tb__DOT__ahbs_swc_inst__DOT__state),4);
    bufp->fullCData(oldp+16,(vlSelf->ahbs_swc_tb__DOT__ahbs_swc_inst__DOT__next_state),4);
    bufp->fullIData(oldp+17,(vlSelf->ahbs_swc_tb__DOT__hwdata),32);
