...
VL_ATTR_COLD void Vahbs_swc___024root__trace_init_sub__TOP__0(Vahbs_swc___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbs_swc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbs_swc___024root__trace_init_sub__TOP__0\n"); );
    // Init
    ...
    tracep->declBit(c+18,"hready", false,-1);
    tracep->declBit(c+19,"hresp", false,-1);
    tracep->declBit(c+10,"wreq", false,-1);
    tracep->declBus(c+11,"wbuffdata", false,-1, 31,0);
    tracep->declBus(c+12,"wbuffaddr", false,-1, 31,0);
    tracep->declBit(c+13,"rreq", false,-1);
    tracep->declBus(c+20,"rbuffdata", false,-1, 31,0);
    tracep->declBus(c+14,"rbuffaddr", false,-1, 31,0);
    ...
    tracep->declBus(c+15,"state", false,-1, 3,0);
    tracep->declBus(c+17,"next_state", false,-1, 3,0);
    tracep->popNamePrefix(2);
}

VL_ATTR_COLD void Vahbs_swc___024root__trace_init_top(Vahbs_swc___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbs_swc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbs_swc___024root__trace_init_top\n"); );
    // Body
    Vahbs_swc___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void Vahbs_swc___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
...
VL_ATTR_COLD void Vahbs_swc___024root__trace_register(Vahbs_swc___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbs_swc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbs_swc___024root__trace_register\n"); );
    // Body
    tracep->addFullCb(&Vahbs_swc___024root__trace_full_top_0, vlSelf);
    tracep->addChgCb(&Vahbs_swc___024root__trace_chg_top_0, vlSelf);
    tracep->addCleanupCb(&Vahbs_swc___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vahbs_swc___024root__trace_full_sub_0(Vahbs_swc___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vahbs_swc___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbs_swc___024root__trace_full_top_0\n"); );
    // Init
    Vahbs_swc___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vahbs_swc___024root*>(voidSelf);
    Vahbs_swc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vahbs_swc___024root__trace_full_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vahbs_swc___024root__trace_full_sub_0(Vahbs_swc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbs_swc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbs_swc___024root__trace_full_sub_0\n"); );
    // Init
    ...
    bufp->fullIData(oldp+9,(vlSelf->ahbs_swc_tb__DOT__hrdata),32);
    bufp->fullBit(oldp+10,(vlSelf->ahbs_swc_tb__DOT__wreq));
    bufp->fullIData(oldp+11,(vlSelf->ahbs_swc_tb__DOT__wbuffdata),32);
    bufp->fullIData(oldp+12,(vlSelf->ahbs_swc_tb__DOT__wbuffaddr),32);
    bufp->fullBit(oldp+13,(vlSelf->ahbs_swc_tb__DOT__rreq));
    bufp->fullIData(oldp+14,(vlSelf->ahbs_swc_tb__DOT__rbuffaddr),32);
    bufp->fullCData(oldp+15,(vlSelf->ahbs_swc_tb__DOT__ahbs_swc_inst__DOT__state),4);
    bufp->fullBit(oldp+16,(vlSelf->ahbs_swc_tb__DOT__hclk));
    bufp->fullCData(oldp+17,(vlSelf->ahbs_swc_tb__DOT__ahbs_swc_inst__DOT__next_state),4);
    bufp->fullBit(oldp+18,(vlSelf->ahbs_swc_tb__DOT__hready));
    bufp->fullBit(oldp+19,(vlSelf->ahbs_swc_tb__DOT__hresp));
    bufp->fullIData(oldp+20,(vlSelf->ahbs_swc_tb__DOT__rbuffdata),32);
