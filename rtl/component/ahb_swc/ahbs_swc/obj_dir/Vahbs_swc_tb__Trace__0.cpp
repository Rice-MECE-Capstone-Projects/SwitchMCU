...
void Vahbs_swc_tb___024root__trace_chg_sub_0(Vahbs_swc_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vahbs_swc_tb___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbs_swc_tb___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vahbs_swc_tb___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vahbs_swc_tb___024root__trace_chg_sub_0(Vahbs_swc_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vahbs_swc_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vahbs_swc_tb___024root__trace_chg_sub_0\n"); );
    // Init
