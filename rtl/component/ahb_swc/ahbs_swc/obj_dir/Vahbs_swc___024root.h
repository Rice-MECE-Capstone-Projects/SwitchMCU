...
#ifndef VERILATED_VAHBS_SWC___024ROOT_H_
#define VERILATED_VAHBS_SWC___024ROOT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vahbs_swc___024root final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vahbs_swc___024root(Vahbs_swc__Syms* symsp, const char* v__name);
    ~Vahbs_swc___024root();
    VL_UNCOPYABLE(Vahbs_swc___024root);
