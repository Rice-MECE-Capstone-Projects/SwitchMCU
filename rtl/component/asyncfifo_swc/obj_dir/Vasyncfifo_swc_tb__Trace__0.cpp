...
void Vasyncfifo_swc_tb___024root__trace_chg_0_sub_0(Vasyncfifo_swc_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vasyncfifo_swc_tb___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vasyncfifo_swc_tb___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vasyncfifo_swc_tb___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vasyncfifo_swc_tb___024root__trace_chg_0_sub_0(Vasyncfifo_swc_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vasyncfifo_swc_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vasyncfifo_swc_tb___024root__trace_chg_0_sub_0\n"); );
    // Init
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgSData(oldp+3,((0x1ffU & (VL_SHIFTR_III(9,9,32, (IData)(vlSelf->asyncfifo_swc_tb__DOT__asyncfifo_swc_inst__DOT__raddr_ptr), 1U) 
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgSData(oldp+9,((0x1ffU & (VL_SHIFTR_III(9,9,32, (IData)(vlSelf->asyncfifo_swc_tb__DOT__asyncfifo_swc_inst__DOT__waddr_ptr), 1U) 
    ...
    bufp->chgBit(oldp+15,(vlSelf->asyncfifo_swc_tb__DOT__wen));
