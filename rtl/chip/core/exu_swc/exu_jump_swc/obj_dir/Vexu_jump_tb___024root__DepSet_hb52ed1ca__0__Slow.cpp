...
VL_ATTR_COLD void Vexu_jump_tb___024root___eval_initial__TOP(Vexu_jump_tb___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vexu_jump_tb___024root___eval_initial__TOP\n"); );
    // Init
    VlWide<4>/*127:0*/ __Vtemp_1;
    // Body
    __Vtemp_1[0U] = 0x2e766364U;
    __Vtemp_1[1U] = 0x705f7462U;
    __Vtemp_1[2U] = 0x5f6a756dU;
    __Vtemp_1[3U] = 0x657875U;
...
VL_ATTR_COLD void Vexu_jump_tb___024root___eval_triggers__stl(Vexu_jump_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vexu_jump_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vexu_jump_tb___024root___eval_triggers__stl\n"); );
    // Body
