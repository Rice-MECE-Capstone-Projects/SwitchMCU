...
VL_ATTR_COLD void Vexu_top_tb___024root___eval_initial__TOP(Vexu_top_tb___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vexu_top_tb___024root___eval_initial__TOP\n"); );
    // Init
...
VL_ATTR_COLD void Vexu_top_tb___024root___eval_triggers__stl(Vexu_top_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vexu_top_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vexu_top_tb___024root___eval_triggers__stl\n"); );
    // Body
