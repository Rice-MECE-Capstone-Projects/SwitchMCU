...
#endif
                VL_FATAL_MT("/home/nand/SwitchMCU/rtl/chip/lib/peripherals_swc/ahb2apb_swc_tb.v", 2, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vahb2apb_swc_tb___024root___ctor_var_reset(Vahb2apb_swc_tb___024root* vlSelf) {
    ...
    vlSelf->ahb2apb_swc_tb__DOT__pslverr = VL_RAND_RESET_I(1);
    ...
    vlSelf->ahb2apb_swc_tb__DOT__spictrl_swc_inst__DOT__maxcnt = VL_RAND_RESET_I(12);
    ...
    vlSelf->ahb2apb_swc_tb__DOT__spictrl_swc_inst__DOT__sck_source_r = VL_RAND_RESET_I(1);
