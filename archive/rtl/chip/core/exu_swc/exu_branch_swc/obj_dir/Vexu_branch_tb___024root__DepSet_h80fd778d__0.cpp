...
void Vexu_branch_tb___024root___eval_triggers__act(Vexu_branch_tb___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vexu_branch_tb___024root___eval_triggers__act\n"); );
    // Body
    vlSelf->__VactTriggered.set(0U, ((IData)(vlSelf->exu_branch_tb__DOT__hclk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__exu_branch_tb__DOT__hclk__0))));
    vlSelf->__VactTriggered.set(1U, (((IData)(vlSelf->exu_branch_tb__DOT__hclk) 
                                      & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__exu_branch_tb__DOT__hclk__0))) 
                                     | ((~ (IData)(vlSelf->exu_branch_tb__DOT__hrstn)) 
                                        & (IData)(vlSelf->__Vtrigprevexpr___TOP__exu_branch_tb__DOT__hrstn__0))));
