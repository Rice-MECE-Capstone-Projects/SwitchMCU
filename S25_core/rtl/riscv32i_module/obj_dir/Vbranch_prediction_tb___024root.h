...
class alignas(VL_CACHE_LINE_BYTES) Vbranch_prediction_tb___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ branch_prediction_tb__DOT__actual_branch_trigger;
    CData/*0:0*/ branch_prediction_tb__DOT__curr_branch_temp;
    ...
    CData/*0:0*/ branch_prediction_tb__DOT__branch_inst__DOT__predict_trigger_prev;
    CData/*0:0*/ branch_prediction_tb__DOT__branch_inst__DOT__actual_branch;
    CData/*0:0*/ __Vtrigprevexpr___TOP__branch_prediction_tb__DOT__clk__0;
    CData/*0:0*/ __VactContinue;
    IData/*31:0*/ branch_prediction_tb__DOT__temp_imm;
    IData/*31:0*/ branch_prediction_tb__DOT__temp_pc_o;
    IData/*31:0*/ branch_prediction_tb__DOT__temp_pc;
    IData/*31:0*/ branch_prediction_tb__DOT__branch_inst__DOT__pc_temp;
    IData/*31:0*/ branch_prediction_tb__DOT__branch_inst__DOT__ins_mem__DOT__pc_reg;
    IData/*31:0*/ __VactIterCount;
    VlUnpacked<IData/*31:0*/, 10000000> branch_prediction_tb__DOT__branch_inst__DOT__ins_mem__DOT__memory;
